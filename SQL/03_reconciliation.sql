...
-- 1. Identify duplicate employee records in the operations dataset
...
-- 2. Identify master employees missing from operations
...
-- 3. Identify operations records without a corresponding master employee
...
-- 4. Identify terminated employees with active payroll status
